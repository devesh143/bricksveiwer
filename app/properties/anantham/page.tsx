...
const formSchema = z.object({
  ...
  message: z.string(),
  formname: z.literal("Anantham Form"),
});
...
const Anantham = () => {
  ...
  React.useEffect(() => {
    ...
    if (phn) {
      ...
      redirect("/phone?redirect=/properties/Anantham");
    }
      ...
      <section className="w-full bg-skyBlue">
        <div className="container mx-auto flex justify-center items-center py-8">
          <h1 className="sm:text-2xl md:text-3xl text-4xl text-white font-white font-bold">
            ...
            / <span className="text-black"> Anantham</span>
          </h1>
        </div>
      </section>
          ...
          <CardHeader className="flex flex-col justify-center items-center gap-2">
            ...
            <CardDescription className="flex justify-center items-center">
              <p className="text-sm text-muted-foreground text-justify md:text-center md:text-md md:w-2/3">
                Featuring a <strong>3BHK Luxury Apartment</strong> with a Family
                Lounge, 3 Bedrooms, Modular Open Kitchen, and Lift Lobby. Make
                your dream home a reality with Anantham.
              </p>
            </CardDescription>
          </CardHeader>
          <CardContent className="p-2">
            <div
              id="siteplans_Anantham"
                ...
                <div className="w-full md:w-2/3 flex flex-col justify-center items-center">
                  ...
                  <Table className="border-2 mb-5">
                    ...
                    <TableBody>
                      ...
                      <TableRow key="3">
                        <TableCell>Third Floor</TableCell>
                        <TableCell className="text-right">
                          61.90 Lakhs (with 50% Roof Rights)
                        </TableCell>
                      </TableRow>
                    </TableBody>
                  </Table>
                  <Dialog>
                    <DialogTrigger className="text-skyBlue text-sm md:text-lg font-bold">
                      Click to Open Detailed Price List
                    </DialogTrigger>
